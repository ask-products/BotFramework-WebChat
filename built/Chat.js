...
var Chat = (function (_super) {
    ...
    function Chat(props) {
        ...
        _this.Theme = function () {
            var themeColour = _this.props.themeColour || '#0078d7';
    ...
    Chat.prototype.injectHistory = function (activities) {
        var _this = this;
        var state = this.store.getState();
        activities.forEach(function (activity) {
            _this.store.dispatch({ type: activity.from.id === state.connection.user.id ? 'Receive_Sent_Message' : 'Receive_Message', activity: activity });
        });
    };
    ...
    Chat.prototype.handleKeyDownCapture = function (evt) {
        ...
        if (target === ReactDom.findDOMNode(this.historyRef)
    ...
    Chat.prototype.componentDidMount = function () {
        ...
        if (this.props.rootDialog) {
            ...
            if (this.props.channelData) {
                exports.sendPostBack(botConnection, this.props.rootDialog, {}, this.props.user, '', this.props.channelData);
            }
            else {
                exports.sendPostBack(botConnection, this.props.rootDialog, {}, this.props.user, '');
            }
        }
    ...
    Chat.prototype.render = function () {
        ...
        return (React.createElement(react_redux_1.Provider, { store: this.store },
            React.createElement("div", { className: "wc-chatview-panel", onKeyDownCapture: this._handleKeyDownCapture, ref: this._saveChatviewPanelRef },
                React.createElement(this.Theme, null),
...
exports.sendPostBack = function (botConnection, text, value, from, locale, channelData) {
